...
export default function Index() {
  const {isLoading,handelSocialAuth} = useSocialAuth( )
  return (
         ...
         {/* Demo image */}
            ...
            <View className="flex-col gap-2">
             <TouchableOpacity className="flex-row items-center justify-center bg-white border
              ...
              onPress={()=>{handelSocialAuth('oauth_google')}}
              disabled={isLoading}
              style={{
                shadowColor:"#000",
             ...
             <TouchableOpacity className="flex-row items-center justify-center bg-white border
              border-gray-300 rounded-full py-3 px-6 mt-3"
              onPress={()=>{ handelSocialAuth('oauth_apple')}}
              disabled={isLoading}
              style={{
                shadowColor:"#000",
                shadowOffset:{width:0,height:1},
